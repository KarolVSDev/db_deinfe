...
const FormColeta: React.FC<FormColetaProps> = ({ closeModal }) => {
    ...
    const { register, handleSubmit, reset, formState: { erros } } = useForm<Coleta>({});
    ...
    return (
        <Box sx={{ borderRadius: 2, padding: '20px 20px 20px', boxShadow: '1px 2px 4px' }} component="form" name='formColeta' noValidade onSubmit={handleSubmit(onSubmit)}>
