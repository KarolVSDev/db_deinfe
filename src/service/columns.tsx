...
export const arrayRelationsHeader = [
    ...
    {id:'email', label:'E-mail', minWidth:150},
    {id:'ativo', label:'Ativo', minWidth:150},
    {id:'interessados', label:'Interessados', minWidth:150},
    {id:'processos', label:'Processos', minWidth:150},
    {id:'pessoajurisd', label:'Pessoa Jurisdicionada', minWidth:150}
]


export const procuradorHeader = [
    {id:'nome', label:'Nome', minWidth:150}
]

export const relatorHeader = [
    {id:'nome', label:'Nome', minWidth:150},
    {id:'cargo', label:'Cargo', minWidth:150}
]

export const natAchadoHeader = [
